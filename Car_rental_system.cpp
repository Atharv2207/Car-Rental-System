...
class Manager_functions: public Customer_database,public Employee_database,public Car_database{
    ...
    void update_cust(){
        ...
        if(ch==1){
            ...
            cout<<"--------------The customer record has been updated successfully--------------\n";
        }
        else if(ch==3){
            ...
            cars[customers[id].rented_cars[j].first].available=true;
            cout<<"--------------Due fine of the specified customer updated successfully--------------\n";
        }
        else if(ch==4){
            string name;
    ...
    void update_empl(){
        ...
        if(ch==1){
            ...
            cout<<"--------------The employee record has been updated successfully--------------\n";
        }
        else if(ch==3){
            int fine_per_day=500;
            int amount_paid;
            ...
            cars[employees[id].rented_cars[j].first].available=true;
            cout<<"--------------Due fine of the employee has been updated--------------\n";
        }
        else if(ch==4){
            string name;
            cout<<"Enter the name to be set\n";
